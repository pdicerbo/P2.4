...
eb.truth_A = eb.assemble_truth_a()
eb.apply_bc_to_matrix_expansion(eb.truth_A)
eb.truth_F = eb.assemble_truth_f()
eb.apply_bc_to_vector_expansion(eb.truth_F)
eb.Qa = len(eb.truth_A)
eb.Qf = len(eb.truth_F)
mymu = (65.0, 15.0, 40.0, 70.0, 80.0, 20.0, 30.0, 60.0, 50.0, -0.7, -0.5, 0.5)
eb.setmu(mymu)
eb.truth_solve()
eb.export_solution(eb.snapshot, "TruthSol")
eb.online_solve()
eb.export_solution(eb.reduced, "ReducedSol")

# error:
eb.compute_error(True)
eb.export_solution(eb.error, "Errors")
